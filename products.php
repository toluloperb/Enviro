        ...
        ?>
            <main>
                <?php
                        ...
                        ?>
                            <div class="contentContainer readStory" id="contentContainer" style="height: auto;">
                                ...
                                <div class="imgRow">
                                    <div class="pcsImgs">
                                        <?php
                                            ...
                                            if(mysqli_num_rows($select_query) > 0)
                                            {
                                                ...
                                                {
                                                    ?>
                                                        <img id="nextImage" data-src="<?= $data["images"] ?>" src="<?php echo 'uploads/'. $data["images"] ?>" />
                                                    <?php
                                                }
                                            }
                                            else
                                    ...
                                    <div class="updateImg readImg imageClass" id="prodImg" style="background: url('uploads/<?= $data["images"] ?>')"></div>
                                </div>
                    ...
                    {
                        ?>
                            <div class="headerBackground" style="background: url('assets/images/products_bkg.jpg')">
                                <div class="toppings" style="padding-top: 50px;background-color: #00006eb9;">
                                    <h3>Products</h3>
                                </div>
                            </div>
